...
#
# Modified by Anthony D'Arienzo and Brevan Ellefsen
# 17 June 2018
#
# The original code was not updated to Python3 and had some bugs
# that prevented interpretation of the lolpython code into python
# we fixed that for another project, and we released the modified
# code below.
#
# Forked from code by Andrew Dalke <dalke@dalkescientific.com>
...
# MOAR VALUES 4 LINE BREAKS!!1!
def t_lb(t):
    r"(?:FALLIN(N+|\b))"
    response = ""
    for _ in range(len(t.value) - 5):
        response += "\\n"
    response = "'" + response + "'"
    return INLINE(t, response)
